    ...
    <Section id="projects">
      <div className="container relative z-2">
        <Heading
          ...
          title="When you start building, you realize what you actually need - Jack Dorsey"
        />
          ...
          {benefits.map((item) => (
            ...
            >
              <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] pointer-events-none">
                <h5 className="h5 mb-5 text-n-2">{item.title}</h5>
                <p className="body-2 mb-6 text-n-1">{item.text}</p>
                <div className="flex items-center mt-auto flex-wrap">
